<?php
  ...
  $sql = "SELECT p.idProducto, p.nombreProducto, p.precioProducto, tp.nombreTipoProducto AS tipo FROM producto p, tipoproducto tp WHERE tp.idTipoProducto = p.idTipoProducto AND p.idTipoProducto = '7'";
